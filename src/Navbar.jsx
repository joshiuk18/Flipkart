            ...
            <div className="w-full">
                <div className="bg-blue-500 text-white px-6 py-2 flex items-center justify-center gap-6">
                    <div className="flex flex-col leading-none">
                        ...
                        <span className="text-xs font-semibold italic text-yellow-300">
                            Explore Plus
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-6 text-sm font-medium">
                        <button className="bg-white text-blue-500 px-6 py-1 rounded-sm font-semibold">
                            Login
                        </button>
                ...
                <div className="bg-white border-b px-6 py-2">
                    <ul className="flex items-center justify-between text-sm font-medium">
                        {[
                            ...
                            <li key={item} className="flex items-center gap-1 cursor-pointer hover:text-blue-500">
                                {item}
                            </li>
                        ))}
                    </ul>
